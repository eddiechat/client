...
### Fixed
- Input field hidden by soft keyboard on iOS

## [0.5.0] - 2026-03-15

### Added
- Write mode for composing messages
- Re-implemented action queue

### Changed
- Improved hiding of subject lines

### Fixed
- Fixed inferred topic detection
